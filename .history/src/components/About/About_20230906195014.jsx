            ...
            <div className="container relative z-10 mx-auto px-4 text-gray-300 justify-between gap-24 lg:flex md:px-8">
                ...
                >
                    ...
                    <p className="mt-3">
                        ...
                        </span>, and I&apos;m an Applications Developer with a passion for building high-quality software solutions. With around 3 years of experience in the industry, I&apos;ve been able to expand my skills in a variety of programming languages, libraries, and systems, including HTML, CSS, SASS, JavaScript, React, .NET, ASP.NET, C#, VB.NET, Razor Pages, MVC, Web Forms, SQL, T-SQL, MS SQL Server, Windows, Windows Server, Linux, and ServiceNow.
                    </p>
                    ...
                    <p className="mt-3">Thank you for taking the time to visit my website, and I hope that you&apos;ll find something here that interests you. Please check out some of my projects on my <Link to="/projects">Projects</Link> page, or my GitHub repos on <a href="https://github.com/dnmyers" rel="noreferrer" target="_blank">GitHub</a>. If you have any questions or would like to learn more about my work, please don&apos;t hesitate to get in touch!  My email address is <a href="mailto:daniel.neil.myers@gmail.com">daniel.neil.myers@gmail.com</a>, or you can message me from my <Link to="/contact">Contact</Link> page.</p>
                </motion.div>
