const projectsList = [
    {
        ...
        desc: "This project served as my capstone for Codecademy's React Skill Path.  Jammming is " +
            ...
            "I showcased my proficiency in HTML, CSS, JavaScript, and React, along with version control using Git and " +
            "hosting repositories on GitHub.  This project also demonstrates my knowledge of HTTP requests and responses, " +
            "and authentication with the Spotify API.  " + <span style={{ fontWeight: '600' }}> + "Click this card to see it in action" + </span> + " or click the Github link below " +
