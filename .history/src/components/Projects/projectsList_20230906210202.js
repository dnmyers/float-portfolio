const projectsList = [
    {
        ...
        category: ["React", "HTML", "CSS", "JavaScript", "Spotify API"],
    ...
    // },
    {
        ...
        category: ["React", "HTML", "CSS", "JavaScript", "Yelp API"],
    },
    {
        ...
        category: ["React", "Tailwind CSS", "Framer Motion", "React Router", "EmailJS","HTML", "CSS", "JavaScript"],
    },
    {
        title: "League",
        ...
        category: [".NET", "ASP.NET", "Entity Framework", "LINQ", "Razor Pages", "C#.NET", "HTML", "CSS", "JavaScript", "Bootstrap"],
    },
];
