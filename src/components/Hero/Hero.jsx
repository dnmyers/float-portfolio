...
const Hero = () => {
    ...
    return (
        <div className='bg-gray-900 pb-32'>
            <section className='pt-24 mx-auto max-w-screen-xl h-full pb-12 px-4 items-center lg:flex md:px-8 lg:flex-grow lg:py-32'>
                <motion.div
                ...
                >
                    <h1 className='text-white font-bold text-3xl pb-2 md:text-4xl xl:text-5xl'>
                        Hi, I&apos;m
                ...
                <motion.div
                    className='flex-1 text-center mt-4 lg:mt-0 lg:ml-3 lg:pr-8'
                    initial={{
                        translateX: 150,
                    }}
                    animate={{
                ...
                >
                    {/* <img
                        ...
                        className='w-full mx-auto hidden md:block sm:w-10/12 lg:w-full'
