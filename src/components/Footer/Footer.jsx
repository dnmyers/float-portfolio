    ...
    return (
        <footer className="text-gray-500 bg-gray-900 px-4 py-5 mx-auto md:px-8">
            <div className="max-w-lg sm:mx-auto sm:text-center">
                <a href="/"><img src="/images/logo2.svg" className="w-32 sm:mx-auto" /></a>
                <p className="leading-relaxed mt-2 text-[15px]">
                    Thank you for taking the time to check out my website!  I look forward to hearing from you and hope to work with you soon!
                </p>
            </div>
            <ul className="items-center justify-center mt-8 space-y-5 sm:flex sm:space-x-4 sm:space-y-0">
                {
                    footerNavs.map((item, i) => (
                        <li key={i} className=" hover:text-gray-800">
